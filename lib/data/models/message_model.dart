...
class MessageModel {
  ...
  factory MessageModel.fromJson(Map<String, dynamic> json) => MessageModel(
        ...
        mediaUrl: (json['media'] ?? json['media_url'] ?? json['mediaUrl'] ?? json['url'])?.toString(),
        mediaSize: _toInt(json['mediaDetails']?['mediaSize'] ?? json['media_size'] ?? json['mediaSize'] ?? json['size']),
        mediaDuration: _toInt(json['mediaDetails']?['duration'] ?? json['media_duration'] ?? json['mediaDuration'] ?? json['duration']),
